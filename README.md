...
⚙️ Tech Stack
LayerTechnologyAppPython + FastAPIContainerDockerRegistryAWS ECROrchestrationAWS ECS FargateLoad BalancerAWS ALBInfrastructureTerraformCI/CDGitHub ActionsMonitoringCloudWatch + SNS
